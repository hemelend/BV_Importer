...
ActiveRecord::Schema.define(version: 20151019194543) do
  ...
  create_table "marketing_stats", force: :cascade do |t|
  ...
  add_index "marketing_stats", ["imported_file_id"], name: "index_marketing_stats_on_imported_file_id", using: :btree
